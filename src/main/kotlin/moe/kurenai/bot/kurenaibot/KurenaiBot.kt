...
import moe.kurenai.bot.kurenaibot.config.CommonHeaderInterceptor
import moe.kurenai.bot.kurenaibot.event.Event
import moe.kurenai.bot.kurenaibot.netty.WebSocketChannelInitializer
import moe.kurenai.bot.kurenaibot.netty.WebSocketServerChannelInitializer
...
class KurenaiBot(
    ...
    private val retrofit = Retrofit.Builder()
        ...
        .addConverterFactory(JacksonConverterFactory.create(moe.kurenai.bot.kurenaibot.Constant.MAPPER))
        .build()
    val api = retrofit.create(moe.kurenai.bot.kurenaibot.CqAPI::class.java)
